...
#ifndef _FAST_DDS_GENERATED_SYS_MSG_IMAGESHM_H_
#define _FAST_DDS_GENERATED_SYS_MSG_IMAGESHM_H_
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(IMAGESHM_SOURCE)
#define IMAGESHM_DllAPI __declspec( dllexport )
#else
#define IMAGESHM_DllAPI __declspec( dllimport )
#endif // IMAGESHM_SOURCE
#else
#define IMAGESHM_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define IMAGESHM_DllAPI
#endif // _WIN32
...
namespace sys {
    namespace msg {
        /*!
         * @brief This class represents the structure ImageSHM defined by the user in the IDL file.
         * @ingroup ImageSHM
         */
        class ImageSHM
        {
        public:
             ...
             */
            eProsima_user_DllExport ImageSHM();
             ...
             * @param x Reference to the object sys::msg::ImageSHM that will be copied.
             */
            eProsima_user_DllExport ImageSHM(
                    const ImageSHM& x);
             ...
             * @param x Reference to the object sys::msg::ImageSHM that will be copied.
             */
            eProsima_user_DllExport ImageSHM& operator =(
                    const ImageSHM& x);
             ...
             * @param x sys::msg::ImageSHM object to compare.
             */
             ...
             */
            eProsima_user_DllExport const sys::msg::Header& head() const;

            /*!
             * @brief This function returns a reference to member head
             * @return Reference to member head
             */
            eProsima_user_DllExport sys::msg::Header& head();
            /*!
             ...
             */
            eProsima_user_DllExport const std::array<uint8_t, 8192>& data() const;

            /*!
             * @brief This function returns a reference to member data
             * @return Reference to member data
             */
            eProsima_user_DllExport std::array<uint8_t, 8192>& data();
        ...
        private:
            ...
            uint32_t m_step;
            std::array<uint8_t, 8192> m_data;

        };
    } // namespace msg
} // namespace sys

#endif // _FAST_DDS_GENERATED_SYS_MSG_IMAGESHM_H_
